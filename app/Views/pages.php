   ...
   <body>
      ...
      <div class="Header" id="Home">
         <nav class="navbar fixed-top">
            <div class="container">
               <a class="navbar-brand" href="#">Sistem Penggajian Karyawan</a>
            ...
            <div class="layer">
               <div class="row Section">
                  <div class="col">
                     <div class="box">
                        <div>
                           <h2><b><i>BERKAH TEXTILE</i></b></h2>
                        </div>
                        <p>Sistem ini dibuat untuk memenuhi tugas akhir mata kuliah Pemrograman Berbasis WEB II</p>
                     </div>
                  </div>
      ...
      <!-- <div class="Service" id="Tentang">
         <div class="Section">
            <div class="text-center">
               <h2><b>PT. Fenadismafa</b></h2>
               <p></p>
               <p></p>
               <div class="subHeading">
                  \Aplikasi ini dibuat guna menyelesaikan tugas akhir mata kuliah Pemrograman Berbasis Web II<br>Dosen Pengampu : Wahyu Setiyanto, M.Kom</div>
            </div>
                  ...
                  <div class="col-md-6 col-lg-4 col-xl-3 ">
                     <div class="card">
                        ...
                        <div class="body">
                           ...
                           <div id="panel1">aplikasi penggajian karyawan</div>
                        </div>
                     </div>
                  </div>
